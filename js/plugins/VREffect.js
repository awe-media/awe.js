...
THREE.VREffect = function ( renderer, done ) {
	...
	this.setSize = function( width, height, resize_canvas ) {
		renderer.setSize( width, height, resize_canvas );
	};
	...
	this.setFullScreen = function( enable ) {
		...
		if ( !enable ) {
			...
			renderer.setSize( canvasOriginalSize.width, canvasOriginalSize.height, false );
			return;
		}
		// VR Mode enabled
